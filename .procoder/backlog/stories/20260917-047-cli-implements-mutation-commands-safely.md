...
`cli.BuildSyncPatch`, `cli.BuildSuspendPatch`, and `MutationPatch` were removed: `solder approve` sends one explicit merge patch with the approved Revision and plan digest, and suspend and resume update the Application.
