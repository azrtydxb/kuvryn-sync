# source-to-pod-lineage

Status: done
Created: 2026-09-17
Milestone: phase-8-integration-contracts
Spec: solder-full-product

## Description

Trace running Pods back through Solder Revision, desired Git, artifact digest, pipeline run, and source commit.
