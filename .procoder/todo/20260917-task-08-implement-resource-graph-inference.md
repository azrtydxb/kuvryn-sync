...
Built-in relationship inference, graph model, ordering/health/visualization consumers.
...
- Implemented resource graph inference for owner refs, Service selectors, PVC mounts, and ConfigMap/Secret env dependencies with deterministic JSON-ready nodes/edges and tests. Gates passed: make fmt test, procoder test/lint/security/check.
