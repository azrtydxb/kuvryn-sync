...
Config-gated repair with SSA conflict safety and tests.
...
- Implemented self-heal gating requiring Drifted state, explicit selfHeal enablement, mutation safety, and no SSA conflicts with tests. Gates passed: make fmt test, procoder test/lint/security/check.
