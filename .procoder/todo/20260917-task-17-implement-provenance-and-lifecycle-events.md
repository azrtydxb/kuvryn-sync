...
Provider-neutral provenance, typed event model, optional event sink boundary.
...
- Implemented provider-neutral provenance validation and stable typed lifecycle event constants with tests. Gates passed: make fmt test, procoder test/lint/security/check.
