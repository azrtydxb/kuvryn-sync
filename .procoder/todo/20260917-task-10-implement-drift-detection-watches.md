...
Managed resource watches, indexes, diff-to-drift status, storm-safe queues.
...
- Implemented managed resource watch mapping, normalized drift classification, and independent drift sync status helpers with tests. Gates passed: make fmt test, procoder test/lint/security/check.
