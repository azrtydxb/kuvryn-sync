...
| `sync.kuvryn.io/rollback-target-hash`         | Application (annotation)     | webhook            | Desired-state hash of the chosen Revision when the rollback was requested; the rollback approves it only while it is unchanged.                                                                                                  |
