...
spec: {interval: 1m, url: https://github.com/azrtydxb/kuvryn-sync-e2e-app.git, ref: {branch: main}}
---
...
Y
k create namespace kuvryn-sync-e2e >/dev/null
